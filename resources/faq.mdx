...
<AccordionGroup>
  ...
  <Accordion title="Is RAXE open source?">
    RAXE Community Edition is **source-available** under a proprietary licence. The source code is viewable on GitHub, but it is not licensed under an OSI-approved open-source licence. See our [Licence](https://github.com/raxe-ai/raxe-ce/blob/main/LICENSE) for full terms.
  </Accordion>
  ...
  <Accordion title="How does RAXE compare to alternatives?">
    ...
    | Detection rules | 515+ | Usually fewer |
...
<AccordionGroup>
  ...
  <Accordion title="Is my data safe?">
    ...
    - Telemetry is anonymised and aggregated
...
<AccordionGroup>
  <Accordion title="How many rules does RAXE have?">
    Community Edition includes **515+ detection rules** across 7 L1 rule families (plus 4 agentic-specific and 14 L2 threat families):
  ...
  <Accordion title="Why am I getting false positives?">
    ...
    You can also create [suppression rules](/concepts/suppressions) for known false positives.
  </Accordion>
