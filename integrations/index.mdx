...
<Info>
All integrations use the same underlying detection engine with 460+ rules and ML-based classification. Choose the integration that matches your architecture.
</Info>
